...
import { Mail, FlaskConical, Microscope, UserPlus, Newspaper, Rocket } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white">
      ...
      <section className="px-6 py-10 max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-4">
          Synthera is an AI-native drug discovery engine that leverages multimodal learning to generate novel compounds, predict
          efficacy, evaluate toxicity, and model bioavailability across molecular and protein targets.
        </p>
        <p className="text-lg text-slate-300">
          Hosted on Azure, Synthera integrates transformer-based models, GNNs, VAEs, and docking tools to provide a comprehensive
          drug design pipeline. Our goal is to democratize next-gen therapeutics for researchers worldwide.
        </p>
      </section>
      ...
      <section className="bg-slate-950 px-6 py-12 text-center">
        ...
        <form className="flex flex-col md:flex-row justify-center items-center gap-3 max-w-md mx-auto">
          <Input type="email" placeholder="Enter your email" className="bg-white text-black w-full md:w-auto" />
